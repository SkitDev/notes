...
<body>
                    ...
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="{{ route('notes.index') }}">All your notes</a>
                                <a class="dropdown-item" href="{{ route('notes.add') }}">Add a note</a>
                            </div>
                        </li>
                    </ul>
    ...
    <script>
        let inscrybmde = new InscrybMDE({ element: document.getElementById("note") });
    </script>
